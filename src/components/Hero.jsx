...
export default function Hero() {
  return (
    <section
      id="hero"
      className="pt-20 text-base md:pt-24 lg:pt-32 px-4 md:px-8 lg:px-16 max-w-screen-xl mx-auto text-slate-950"
    >
      <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12 2xl:gap-8">
        ...
        {/* Imagen */}
        <LayoutReveal isHero className="delay-400 md:w-1/2 lg:w-80 lg:mx-auto xl:w-96 2xl:mx-0">
